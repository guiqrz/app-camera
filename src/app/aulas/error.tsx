...
/**
 * Tela de falha ao carregar as aulas.
 *
 ...
 */
export default function ErroAulas({ error, reset }: ErrorProps) {
  useEffect(() => {
    // Detalhe tecnico vai para o console, nao para a tela do professor.
    ...
    <main className="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center gap-5 px-6 text-center">
      ...
      <h1 className="text-text text-xl font-extrabold">
        {pareceApiForaDoAr
          ...
          : "Algo deu errado ao carregar as aulas"}
      </h1>
